...
<script type="text/javascript">
	...
	function pageList(pageNo,pageSize){
		...
		//查询前，先将隐藏域中的信息赋予到搜索框中
		$("#search-name").val($.trim($("#hide-name").val()));
		$("#search-owner").val($.trim($("#hide-owner").val()));
		$("#search-startDate").val($.trim($("#hide-startTime").val()));
		$("#search-endDate").val($.trim($("#hide-endTime").val()));
		$.ajax({
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel1">新增住户投诉</h4>
				</div>
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-marketActivityOwner" class="col-sm-2 control-label">投诉者<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-Owner">
								</select>
							</div>
                            <label for="create-marketActivityName" class="col-sm-2 control-label">投诉名称<span style="font-size: 15px; color: red;">*</span></label>
                            <div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<label for="create-startTime" class="col-sm-2 control-label">第一次投诉日期</label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<label for="create-describe" class="col-sm-2 control-label">住户投诉描述</label>
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel2">修改住户投诉</h4>
				</div>
				<div class="modal-body">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">投诉者</div>
