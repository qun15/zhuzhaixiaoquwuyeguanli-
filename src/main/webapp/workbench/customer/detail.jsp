...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>住户详细信息页面 <small><a href="http://www.bjpowernode.com" target="_blank"></a></small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			<div style="width: 300px; color: gray;">住户姓名</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${u.name}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			<div style="width: 300px; color: gray;">手机号码</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${u.phone}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">身份证号</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${u.sfz}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			<div style="width: 300px; color: gray;">入住时间</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${u.name}&nbsp;&nbsp;</b>
				<small style="font-size: 10px; color: gray;">${u.expireTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
        <div style="position: relative; left: 40px; height: 30px; top: 40px;">
            <div style="width: 300px; color: gray;">备注信息</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 60px;">
			<div style="width: 300px; color: gray;">停车位</div>
			<div style="width: 630px;position: relative; left: 200px; top: -20px;">
				<b>
					${u.park}
				</b>
