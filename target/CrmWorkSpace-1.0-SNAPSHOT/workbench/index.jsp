...
<script type="text/javascript">
	...
	$(function(){
		...
		window.open("workbench/customer/index.jsp","workareaFrame");
		<%--$("#miMa").click(function (){--%>
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						失效时间：<b>2021-06-14 10:10:10</b><br><br>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="gaiMiMa" >更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">住宅小区物业管理系统 &nbsp;<span style="font-size: 16px;">&copy;2021&nbsp;&nbsp;&nbsp;&nbsp;计算机171高轶群</span></div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="workbench/customer/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 住户信息</a></li>
